...
- Run legacy/regression/UI tests: npm test (108/108 passed in the latest local review; Quant offline tests 56/56 passed). Run npm run test:postgres only against an isolated test database; the recorded PostgreSQL integration result is 15/15, not a fresh production test.
